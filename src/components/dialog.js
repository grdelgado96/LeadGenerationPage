...
/**
 * ModalDialog component for displaying modal dialogs.
 * @module components/ModalDialog
 * @returns {JSX.Element} JSX element representing the modal dialog component.
 */
          ...
          <div className="relative transform overflow-hidden rounded-lg bg-white shadow-xl">
              ...
              <div className="mt-5 text-center ">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    {modal.response
                      ? "We are going to reach you soon!"
                      : "We are having trouble rigth now. Please try again later!"}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 px-4 py-3 flex justify-center sm:px-6">
              <button
                ...
                className={
                  modal.response
                    ? "inline-flex justify-center rounded-md  px-3 py-2 text-sm font-semibold text-white shadow-sm  sm:w-auto bg-emerald-900 hover:bg-emerald-700"
