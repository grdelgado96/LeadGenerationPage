      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Join our mailing list!</h2>
            <p className="mt-4 text-lg leading-8 text-gray-300">
              Be the first to know about new offers, ideas, tutorials and inventory.
            </p>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-gray-400">
                Every week we came with new ideas to share with you.
              </dd>
            </div>
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
              ...
              <dd className="mt-2 leading-7 text-gray-400">
                We respect your privacy! We will not spam you or send you emails every day.
              </dd>
            </div>
          </dl>
        </div>
